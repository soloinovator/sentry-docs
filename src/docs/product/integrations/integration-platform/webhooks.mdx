...
: The data object contains information about the [resource](#sentry-hook-resource) and will differ in content depending on the type of webhook.
...
# Sentry ([sentry.io](https://sentry.io)) auto resolves an issue
"actor": {
    "type": "application",
    "id": "sentry",
    "name": "Sentry",
...
<Note>
You cannot set up a custom payload. Instead, we suggest setting up a server or service that proxies our webhook into a request that fits your use case.
</Note>

## Event Types

- [Installation & Uninstallation](/product/integrations/integration-platform/webhooks/installation/)
...
- [Error](/product/integrations/integration-platform/webhooks/error/)

- [External Issues](/product/integrations/integration-platform/ui-components/issue-link)

- [Select Options](/product/integrations/integration-platform/ui-components/formfield/#select)
